...
async function main() {
    ...
    const productData = [
        ...
        // Monitors
        { title: 'LG 27GP850-B 27" QHD Gaming', price: 29999, stock: 7, category: 'Monitors', brand: 'LG', image: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=500', description: '27-inch Nano IPS, 165Hz, 1ms, HDR400 gaming monitor.', specs: { Size: '27"', Resolution: '2560x1440', 'Refresh Rate': '165Hz', Panel: 'Nano IPS', 'Response Time': '1ms' }, rating: 4.7, numReviews: 40 },
        { title: 'Samsung Odyssey G5 34" Ultrawide', price: 34999, stock: 5, category: 'Monitors', brand: 'Samsung', image: 'https://images.unsplash.com/photo-1593640408182-31c70c8268f5?w=500', description: '34-inch UWQHD curved VA, 165Hz gaming monitor.', specs: { Size: '34"', Resolution: '3440x1440', 'Refresh Rate': '165Hz', Panel: 'VA Curved', Curvature: '1000R' }, rating: 4.4, numReviews: 22 },

        // Peripherals
        { title: 'Logitech G Pro X Superlight 2', price: 12999, stock: 25, category: 'Peripherals', brand: 'Logitech', image: 'https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=500', description: 'Ultra-lightweight wireless gaming mouse, 63g, HERO 2 sensor.', specs: { Weight: '63g', Sensor: 'HERO 2', DPI: '32,000', Battery: '95 hours' }, rating: 4.8, numReviews: 88 },
        { title: 'Keychron Q1 Pro Mechanical Keyboard', price: 16999, stock: 12, category: 'Peripherals', brand: 'Keychron', image: 'https://images.unsplash.com/photo-1595225476474-87563907a212?w=500', description: '75% wireless mechanical keyboard with hot-swappable Gateron Jupiter Red switches.', specs: { Layout: '75%', Switches: 'Gateron Jupiter Red', Connectivity: 'BT/2.4G/USB-C', Backlight: 'RGB' }, rating: 4.6, numReviews: 34 },
        { title: 'HyperX Cloud III Wireless', price: 10999, stock: 18, category: 'Peripherals', brand: 'HyperX', image: 'https://images.unsplash.com/photo-1599669454699-248893623440?w=500', description: 'Wireless gaming headset with 53mm drivers and DTS:X spatial audio.', specs: { Driver: '53mm', Battery: '120 hours', Mic: 'Detachable', Audio: 'DTS:X Spatial' }, rating: 4.5, numReviews: 47 },

        // Laptops
        { title: 'ASUS ROG Strix G16 (2024)', price: 129999, stock: 4, category: 'Laptops', brand: 'ASUS', image: 'https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=500', description: 'Intel i9-14900HX, RTX 4070, 16" 240Hz QHD, 32GB DDR5 gaming laptop.', specs: { CPU: 'i9-14900HX', GPU: 'RTX 4070 8GB', RAM: '32GB DDR5', Storage: '1TB NVMe', Display: '16" QHD 240Hz' }, rating: 4.7, numReviews: 15 },
        { title: 'Lenovo IdeaPad Slim 5', price: 54999, stock: 10, category: 'Laptops', brand: 'Lenovo', image: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500', description: 'Ryzen 7 7730U, 16GB RAM, 512GB SSD — perfect productivity laptop.', specs: { CPU: 'Ryzen 7 7730U', RAM: '16GB', Storage: '512GB SSD', Display: '15.6" FHD IPS' }, rating: 4.3, numReviews: 62 },

        // Cooling
        { title: 'Noctua NH-D15 Chromax Black', price: 8999, stock: 11, category: 'Cooling', brand: 'Noctua', image: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=500', description: 'The king of air coolers. Dual tower design with dual 140mm fans.', specs: { Type: 'Air Cooler', Fans: '2x 140mm', TDP: '250W', Height: '165mm' }, rating: 4.9, numReviews: 95 },
        { title: 'Deepcool LS720 360mm AIO', price: 9499, stock: 9, category: 'Cooling', brand: 'Deepcool', image: 'https://images.unsplash.com/photo-1555618254-5e28e2a3de2e?w=500', description: '360mm AIO liquid cooler with ARGB infinity mirror pump head.', specs: { Type: 'AIO Liquid', Radiator: '360mm', Fans: '3x 120mm ARGB', 'Pump Speed': '3100 RPM' }, rating: 4.5, numReviews: 29 },
    ];
