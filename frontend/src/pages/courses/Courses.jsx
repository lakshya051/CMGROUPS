...
const Courses = () => {
    ...
    useSEO({ title: 'Computer Courses in Etah — Shoptify Academy', description: 'Learn Tally Prime, computer basics, web development and more with expert instructors in Etah.' });
