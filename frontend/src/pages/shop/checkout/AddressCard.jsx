...
const AddressCard = ({ address, isSelected, onSelect, onDelete }) => (
    ...
    >
        <button
            ...
            className="absolute top-1 right-1 min-touch rounded-md text-text-muted hover:text-error hover:bg-error/10 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-all"
